...
namespace RniPanel {
    ...
    sealed class PanelWindow:Form {
        ...
        public PanelWindow() {
            Text="RNI Palette · 0.6.2";Name="RniPaletteWindow";StartPosition=FormStartPosition.CenterScreen;
        ...
        void BuildUi() {
            ...
            var sub=MakeLabel("胶片收藏夹   ·   原生样式 / 清除 RNI 0.6.2",26,mute);sub.Dock=DockStyle.None;sub.Top=38;sub.Width=360;header.Controls.Add(sub);
        ...
        void Record(string action,FilmStyle style,string message) {
            ...
            var record=new {at=DateTimeOffset.Now.ToString("o"),version="0.6.2",action=action,
